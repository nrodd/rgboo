...
const Stats = () => {
  ...
  // Nothing dispatched, rollup never run, or aggregates unreachable: all
  // three leave nothing to draw, and a visitor cannot act on which it is.
    ...
    <main className="admin-shell min-h-dvh px-5 py-6 text-bone sm:px-8 sm:py-10">
      <div className="mx-auto flex max-w-6xl flex-col gap-6">
        <header className="flex flex-wrap items-center justify-between gap-4">
          ...
          {/* Only worth showing once it dates something. */}
          {hasData && (
