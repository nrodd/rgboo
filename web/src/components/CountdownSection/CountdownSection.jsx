...
export const CountdownSection = () => {
    ...
    useEffect(() => {
        const calculateTimeLeft = () => {
            ...
            const difference = nextOctober - now;
        ...
        <div className="text-center text-bone space-y-4">
            ...
            <div className="flex justify-center gap-4 text-sm sm:text-base">
                <div className="flex flex-col items-center">
                    <span className="text-2xl sm:text-3xl font-bold text-pumpkin-400">{timeLeft.days}</span>
                    <span className="text-xs opacity-75">Days</span>
                </div>
                <div className="flex flex-col items-center">
                    <span className="text-2xl sm:text-3xl font-bold text-pumpkin-400">{timeLeft.hours}</span>
                    <span className="text-xs opacity-75">Hours</span>
                </div>
                <div className="flex flex-col items-center">
                    <span className="text-2xl sm:text-3xl font-bold text-pumpkin-400">{timeLeft.minutes}</span>
                    <span className="text-xs opacity-75">Minutes</span>
                </div>
                <div className="flex flex-col items-center">
                    <span className="text-2xl sm:text-3xl font-bold text-pumpkin-400">{timeLeft.seconds}</span>
